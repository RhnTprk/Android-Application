...
/*public class BluetoothConnectionService {
    ...
    public void setOnBluetoothConnectingListener(OnBluetoothConnectingListener 1){
        listener = 1;
    }
    public void setOnBluetoothConnectionListener(OnBluetoothConnectionListener 1){
        listener2 = 1;
    }
    ...
    {
        int d = Log.d(TAG, "ConnectedThread: write(), write Called.");
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            {
                e.printStackTrace();
                Log.e(TAG, "ConecctThread: Couldn't create RFcommSocket." + e.getMessage());
                listener.onFailure();
            }
            if(tmp != null)
            {
...
*/
public class BluetoothConnectionService {
    private static String TAG = "BluetoothConnectionService";
    private static final UUID connectionUUID = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");
    private static BluetoothConnectionService instanceBCS;
    private final BluetoothAdapter bluetoothAdapter;
    private BluetoothSocket bluetoothSocket;
